...
/**
 * This sample demonstrates how to upload parts by copy mode to Aliyun OSS using the OSS SDK for Java.
 */
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            for (int i = 0; i < partCount; i++) {
                ...
                UploadPartCopyRequest uploadPartCopyRequest = new UploadPartCopyRequest(sourceBucketName, sourceKey,
                        targetBucketName, targetKey);
