...
/**
 * This sample demonstrates how to do bucket-related operations (such as Bucket
 * ACL/CORS/Lifecycle/Logging/Website/Location) on Aliyun OSS using the OSS SDK for Java.
 */
public class BucketOperationsSample {
    ...
    private static void doBucketLifecycleOperations() {
        ...
        System.out.println("\tRule0: Id=" + r0.getId() + ", Prefix=" + r0.getPrefix() + ", Status=" + r0.getStatus()
                + ", ExpirationDays=" + r0.getExpriationDays());
        System.out.println("\tRule1: Id=" + r1.getId() + ", Prefix=" + r1.getPrefix() + ", Status=" + r1.getStatus()
                + ", ExpirationTime=" + formatISO8601Date(r1.getExpirationTime()));
        System.out.println();
    ...
    private static void doBucketLoggingOperations() {
        ...
        System.out.println(
                "\tTarget bucket=" + result.getTargetBucket() + ", target prefix=" + result.getTargetPrefix() + "\n");
        System.out.println();
    ...
    private static void doBucketRefererOperations() {
        ...
        System.out.println(
                "\tAllow empty referer? " + r.isAllowEmptyReferer() + ", referer list=" + returedRefererList + "\n");
    ...
    private static void doBucketWebsiteOperations() {
        ...
        System.out.println("\tIndex document " + result.getIndexDocument() + ", error document="
