...
/**
 * This sample demonstrates how to get started with basic requests to Aliyun OSS using the OSS SDK for Java.
 */
public class GetStartedSample {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            ObjectListing objectListing = client.listObjects(new ListObjectsRequest(bucketName).withPrefix("My"));
