...
/**
 * This sample demonstrates how to upload an object by append mode to Aliyun OSS using the OSS SDK for Java.
 */
public class AppendObjectSample {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            /*
             * Append an object from specfied input stream, keep in mind that position should be set to zero at first
             * time.
             */
            ...
            AppendObjectResult appendObjectResult = client
                    .appendObject(new AppendObjectRequest(bucketName, key, instream).withPosition(0L));
            System.out.println("\tNext position=" + appendObjectResult.getNextPosition() + ", CRC64="
                    + appendObjectResult.getObjectCRC64() + "\n");
            ...
            appendObjectResult = client.appendObject(
                    new AppendObjectRequest(bucketName, key, createTempFile()).withPosition(nextPosition));
            System.out.println("\tNext position=" + appendObjectResult.getNextPosition() + ", CRC64="
                    + appendObjectResult.getObjectCRC64());
